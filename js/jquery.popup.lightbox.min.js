...
(function (a) {
	a.fn.popupLightbox = function (b) {
		var c = a.extend({ width: 560, height: 340, inAnimation: "ZoomIn" }, b);
		return this.each(function () {
			...
			a(j)
				.addClass("lightbox animated faster " + c.inAnimation)
				.appendTo("body");
			for (var u = 0; u < n.length; u++) {
				a(n)
					.eq(u)
					.attr({ "data-num": u, id: "#img" + u });
			}
			if (a(window).width() > 620) {
				...
				a(j).css({ width: "100%", height: "100%", top: 0, left: 0 });
			}
			...
			a(t).click(function () {
				...
				a(q)
					.find("img")
					.animate({ left: "-100%", opacity: 0 }, 200, function () {
						a(q).html(a(n).eq(f).clone());
						o = a(q).find("img");
						e = a(o).attr("alt");
						if (a(o).prop("alt") == false) {
							e = "This image has no caption";
						}
			...
			a(l).click(function () {
				...
				a(q)
					.find("img")
					.animate({ right: "-100%", opacity: 0 }, 200, function () {
						a(q).html(a(n).eq(f).clone());
						o = a(q).find("img");
						e = a(o).attr("alt");
						a(p).html(e).appendTo(q);

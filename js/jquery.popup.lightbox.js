...
(function ($) {
	$.fn.popupLightbox = function (options) {
		...
		return this.each(function () {
			...
			$(nextBtn).addClass("btn-next").appendTo(popupWindow);

			$(prevBtn).addClass("btn-prev").appendTo(popupWindow);

			$(closeBtn).addClass("btn-close").appendTo(popupWindow).html("&times;");

			$(imgStat).addClass("lightbox-status").appendTo(popupWindow);

			$(imgFig).addClass("img-show").appendTo(popupWindow);

			$(popupWindow)
				.addClass("lightbox animated faster " + setting.inAnimation)
				.appendTo("body");
			...
			$(imgs).click(function () {
				...
				$(imgFig).html(thisImg).parent().fadeIn();
